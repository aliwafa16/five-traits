...
?>
						<form id="frmDemo" action="#" method="POST" class="form-horizantal">
							...
							<div class="form-group row">
								<label class="col-md-4 labelme"><?php echo $label_leaders[SLANGUAGE];?> <span class="text-red">*</span></label>
								<div class="col-md-8">
									<?php
									$leaders[''] = '--- '.$this->lang->line('pilih').' ---';
									echo form_dropdown('leaders',$leaders,false,'id="leaders" class="form-control region custom-select" required style="width:100%"');
									?>
									<input type="hidden" name="leaders_name" id="leaders_name" value="<?php echo $this->session->userdata('leaders_name');?>">
								</div>								
							</div>
							<?php //} ?>
							<?php if( $listdemo['f_region'] == 1){ ?>
...
$yourcode = md5($sAccount.$c_datetime->format("YmdHisu"));
?>
<script type="text/javascript">
function setCookie(e,o,t){var i=new Date;i.setTime(i.getTime()+24*t*60*60*1e3);var n="expires="+i.toUTCString();document.cookie=e+"="+o+";"+n+";path=/"}function getCookie(e){for(var o=e+"=",t=document.cookie.split(";"),i=0;i<t.length;i++){for(var n=t[i];" "==n.charAt(0);)n=n.substring(1);if(0==n.indexOf(o))return n.substring(o.length,n.length)}return""}function checkCode(e){getCookie("tokensurveyleadergeneral")||setCookie("tokensurveyleadergeneral",e,14)}checkCode("<?php echo $yourcode;?>");var mycodesurvey =getCookie('tokensurveyleadergeneral');
$(document).ready(function(){
	...
	$('#frmDemo').submit(function(e){
		...
		e.preventDefault();
		if($(this).valid()) {
			$.post("<?php echo site_url('c/saveDemo/'.$alias);?>?tokensurvey="+mycodesurvey, rec, function(msg){
				if(msg.status == 200)
				{
					window.location.href = "<?php echo site_url('c/'.$alias);?>?tokensurvey="+mycodesurvey;
				}
				else
				{
