...
class Setting_account extends MX_Controller
{
	...
	public function index()
	{
		...
		$data = array(
			'app_title'	=> 'Data Setting Account',
			'app_desc' 	=> 'it all Setting Account',
			'setting'	=> $this->mo_setting_account->getDataId($sAccount),
			'akun'		=> $this->mo_setting_account->getDataAccountId($sAccount),
			'listdemo'	=> $this->mo_setting_account->getDataListDemo($sAccount),
			//'listluan'	=> $this->mo_setting_account->getDataListLaun( $sAccount ),
			'fId'		=> $sAccount,
			'fAct'			=> 'Edit',
		);
...
*/
	...
	public function fnSetting_accountUpdateDemo()
	{
		...
		$data = array(
			'f_demo_view' => $this->input->post('f_demo_view'),
