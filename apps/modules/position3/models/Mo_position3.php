...
class Mo_position3 extends CI_Model {

	public $table = 'table_level_position3';
	...
	{
		$this->db->select('a.f_id,a.f_id2,b.f_position_desc f_desc2,a.f_position_desc,a.f_total,a.f_total_min,a.f_aktif');
		$this->db->join('table_level_position2 b','b.f_id=a.f_id2');
...
/* End of file Mo_position3.php */
/* Location: ./application/modules/Position3/models/Mo_position3.php */	
