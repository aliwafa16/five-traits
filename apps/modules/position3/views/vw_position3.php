	...
	<div class="container-fluid">
		<div class="card"> <!-- start .box -->
			<div class="card-header"> <!-- start .card-header -->
				<a class="btn btn-sm btn-primary" id="addPosition3"><i class="fa fa-plus"></i> Tambah</a>&nbsp;&nbsp;
			</div> <!-- end .card-header -->
			
			<div class="card-body"> <!-- start .card-body -->
				<table id="tablePosition3" class="table datares">
					<thead>
						<tr>				
							<th>No</th>				
							<th>Level 2</th>				
...
$(document).ready(function(){
	oTable = $('#tablePosition3').DataTable({
		"order": [[ 0, "desc" ]],
		"processing": true,
		"serverSide": true,
		"lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
		"ajax": {
            "url": "<?php echo site_url('position3/fnPosition3DataJson');?>",
            "type": "POST"
        },
		"columns": [
	...
	$('#addPosition3').click(function()	{
		window.location.href = "<?php echo site_url('position3/fnPosition3Add');?>";
	});
});

function fnEdit(idRow)
{
	window.location.href = "<?php echo site_url('position3/fnPosition3Edit');?>/"+idRow;
}
...
function fnSwitch(idRow,St)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('position3/fnPosition3Switch');?>';
		if(result.value)
		{
...
function fnDelete(idRow)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('position3/fnPosition3Delete');?>';
		if(result.value)
		{
