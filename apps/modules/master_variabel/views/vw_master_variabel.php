	...
	<div class="container-fluid">
		<div class="card"> <!-- start .box -->
			<div class="card-header"> <!-- start .card-header -->
				<a class="btn btn-sm btn-primary" id="addMaster_variabel"><i class="fa fa-plus"></i> Tambah</a>&nbsp;&nbsp;
			</div> <!-- end .card-header -->
			
			<div class="card-body"> <!-- start .card-body -->
				<table id="tableMaster_variabel" class="table datares">
					<thead>
						<tr>				
							<th>No</th>				
							<th>Nama</th>
...
$(document).ready(function(){
	oTable = $('#tableMaster_variabel').DataTable({
		"order": [[ 0, "desc" ]],
		"processing": true,
		"serverSide": true,
		"lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
		"ajax": {
            "url": "<?php echo site_url('master_variabel/fnMaster_variabelDataJson');?>",
            "type": "POST"
        },
		"columns": [
	...
	$('#addMaster_variabel').click(function()	{
		window.location.href = "<?php echo site_url('master_variabel/fnMaster_variabelAdd');?>";
	});
});

function fnEdit(idRow)
{
	window.location.href = "<?php echo site_url('master_variabel/fnMaster_variabelEdit');?>/"+idRow;
}
...
function fnDelete(idRow)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('master_variabel/fnMaster_variabelDelete');?>';
		if(result.value)
		{
