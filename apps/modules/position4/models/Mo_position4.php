...
class Mo_position4 extends CI_Model {

	public $table = 'table_level_position4';
	...
	{
		$this->db->select('a.f_id,a.f_id3,b.f_position_desc f_desc3,a.f_position_desc,a.f_total,a.f_total_min,a.f_aktif');
		$this->db->join('table_level_position3 b','b.f_id=a.f_id3');
...
/* End of file Mo_position4.php */
/* Location: ./application/modules/Position4/models/Mo_position4.php */	
