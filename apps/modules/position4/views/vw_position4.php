	...
	<div class="container-fluid">
		<div class="card"> <!-- start .box -->
			<div class="card-header"> <!-- start .card-header -->
				<a class="btn btn-sm btn-primary" id="addPosition4"><i class="fa fa-plus"></i> Tambah</a>&nbsp;&nbsp;
			</div> <!-- end .card-header -->
			
			<div class="card-body"> <!-- start .card-body -->
				<table id="tablePosition4" class="table datares">
					<thead>
						<tr>				
							<th>No</th>				
							<th>Level 3</th>				
...
$(document).ready(function(){
	oTable = $('#tablePosition4').DataTable({
		"order": [[ 0, "desc" ]],
		"processing": true,
		"serverSide": true,
		"lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
		"ajax": {
            "url": "<?php echo site_url('position4/fnPosition4DataJson');?>",
            "type": "POST"
        },
		"columns": [
	...
	$('#addPosition4').click(function()	{
		window.location.href = "<?php echo site_url('position4/fnPosition4Add');?>";
	});
});

function fnEdit(idRow)
{
	window.location.href = "<?php echo site_url('position4/fnPosition4Edit');?>/"+idRow;
}
...
function fnSwitch(idRow,St)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('position4/fnPosition4Switch');?>';
		if(result.value)
		{
...
function fnDelete(idRow)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('position4/fnPosition4Delete');?>';
		if(result.value)
		{
