...
class Mo_position2 extends CI_Model {

	public $table = 'table_level_position2';
	...
	{
		$this->db->select('a.f_id,a.f_id1,b.f_position_desc f_desc1,a.f_position_desc,a.f_total,a.f_total_min,a.f_aktif');
		$this->db->join('table_level_position1 b','b.f_id=a.f_id1');
...
/* End of file Mo_position2.php */
/* Location: ./application/modules/Position2/models/Mo_position2.php */	
