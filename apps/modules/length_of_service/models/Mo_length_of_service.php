...
class Mo_length_of_service extends CI_Model {

	public $table = 'table_length_of_service';
	...
	function saveData()
	{
		$data = array(
				...
				'f_service_desc' => $this->input->post('f_service_desc'),
				'f_service_aktif' => 1,
		);
	...
	function switchData()
	{
		...
		$this->db->where('f_account_id',$this->session->userdata('f_account_id'));
		$sql = $this->db->update($this->table,array('f_service_aktif' => $f_value_active ));
		return $sql;		
	}
...
/* End of file Mo_length_of_service.php */
/* Location: ./application/modules/Length_of_service/models/Mo_length_of_service.php */	
