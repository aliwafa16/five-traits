	...
	<div class="container-fluid">
		<div class="card"> <!-- start .box -->
			<div class="card-header"> <!-- start .card-header -->
				<a class="btn btn-sm btn-primary" id="addWork"><i class="fa fa-plus"></i> Tambah</a>&nbsp;&nbsp;
			</div> <!-- end .card-header -->
			
			<div class="card-body"> <!-- start .card-body -->
				<table id="tableWork" class="table datares">
					<thead>
						<tr>				
							<th>No</th>				
							<th>Nama</th>				
...
$(document).ready(function(){
	oTable = $('#tableWork').DataTable({
		"order": [[ 0, "desc" ]],
		"processing": true,
		"serverSide": true,
		"lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
		"ajax": {
            "url": "<?php echo site_url('work/fnWorkDataJson');?>",
            "type": "POST"
        },
		"columns": [
			...
			{ data: 'f_levelwork_desc', name: 'f_levelwork_desc' },
	...
	$('#addWork').click(function()	{
		window.location.href = "<?php echo site_url('work/fnWorkAdd');?>";
	});
});

function fnEdit(idRow)
{
	window.location.href = "<?php echo site_url('work/fnWorkEdit');?>/"+idRow;
}
...
function fnSwitch(idRow,St)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('work/fnWorkSwitch');?>';
		if(result.value)
		{
...
function fnDelete(idRow)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('work/fnWorkDelete');?>';
		if(result.value)
		{
