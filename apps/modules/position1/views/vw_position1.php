	...
	<div class="container-fluid">
		<div class="card"> <!-- start .box -->
			<div class="card-header"> <!-- start .card-header -->
				<a class="btn btn-sm btn-primary" id="addPosition1"><i class="fa fa-plus"></i> Tambah</a>&nbsp;&nbsp;
			</div> <!-- end .card-header -->
			
			<div class="card-body"> <!-- start .card-body -->
				<table id="tablePosition1" class="table datares">
					<thead>
						<tr>				
							<th>No</th>				
							<th>Nama</th>				
...
$(document).ready(function(){
	oTable = $('#tablePosition1').DataTable({
		"order": [[ 0, "desc" ]],
		"processing": true,
		"serverSide": true,
		"lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
		"ajax": {
            "url": "<?php echo site_url('position1/fnPosition1DataJson');?>",
            "type": "POST"
        },
		"columns": [
	...
	$('#addPosition1').click(function()	{
		window.location.href = "<?php echo site_url('position1/fnPosition1Add');?>";
	});
});

function fnEdit(idRow)
{
	window.location.href = "<?php echo site_url('position1/fnPosition1Edit');?>/"+idRow;
}
...
function fnSwitch(idRow,St)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('position1/fnPosition1Switch');?>';
		if(result.value)
		{
...
function fnDelete(idRow)
{
	Swal.fire({
		...
		var urlUpdate='<?php echo site_url('position1/fnPosition1Delete');?>';
		if(result.value)
		{
