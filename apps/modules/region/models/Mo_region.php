...
class Mo_region extends CI_Model {

	public $table = 'table_region';
	...
	function saveData()
	{
		$data = array(
				...
				'f_region_name' => $this->input->post('f_region_name'),
				'f_region_aktif' => 1,
		);
	...
	function switchData()
	{
		...
		$this->db->where('f_account_id',$this->session->userdata('f_account_id'));
		$sql = $this->db->update($this->table,array('f_region_aktif' => $f_value_active ));
		return $sql;		
	}
...
/* End of file Mo_region.php */
/* Location: ./application/modules/Region/models/Mo_region.php */	
